...
cost_df = usnews_df[['inst_name', 'outstate_tuition', 'r&bcost', 'rcost', 'bcost', 'add_fee', 'bookcost', 'pers_exp']]
...
plt.xlabel('Total Expenses of a student in college($)')
plt.ylabel('Number of colleges')
plt.title('Average is $18256')
plt.show()
